...
function LinkindIcon() {
  return (
    ...
    >
      ...
      />
      <path
        d="M5.75 14.125V8.5M9.75 14.125V11.25M9.75 11.25V8.5M9.75 11.25C9.75 9.962 10.972 9.25 12.15 9.25C13.75 9.25 13.75 10.625 13.75 12.125V14.125"
        stroke="#E9CCAE"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
