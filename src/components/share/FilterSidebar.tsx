...
export default function FilterSidebar({
  ...
  return (
    <div className="bg-white dark:bg-[#3e3329] rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700/60 px-5 pt-5 transition-colors duration-200 pb-6 h-full min-h-full overflow-x-hidden no-scrollbar">
