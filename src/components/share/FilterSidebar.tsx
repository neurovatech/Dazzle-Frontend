...
export default function FilterSidebar({
  ...
  return (
    <div className="bg-white dark:bg-[#3e3329] rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700/60 px-5 pt-5 sticky top-6 transition-colors duration-200 pb-14 max-h-[700px] overflow-x-auto no-scrollbar ">
