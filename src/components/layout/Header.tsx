...
export default async function Header() {
  ...
  return (
    <header
      className="w-full font-sans sticky  top-0 z-9999999 lg:static  transition-colors duration-300  rounded-b-[20px] lg:px-4 lg:pt-0! dark:bg-[#1a1a1a] dark:text-white"
      style={{
