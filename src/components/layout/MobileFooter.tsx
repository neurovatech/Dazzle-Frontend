...
const OfferIcon = ({ active }: { active: boolean }) => (
  ...
  >
    <path
      d="M252 128 C 230 95, 210 55, 165 32 C 128 13, 90 20, 78 52 C 68 80, 88 105, 120 112 C 155 120, 200 118, 252 128 Z M232 108 C 195 98, 165 90, 143 78 C 120 65, 108 50, 113 38 C 118 27, 138 27, 158 40 C 190 62, 215 88, 232 108 Z"
      fill="#c0392b"
      fillRule="evenodd"
    />

    <path
      d="M260 128 C 282 95, 302 55, 347 32 C 384 13, 422 20, 434 52 C 444 80, 424 105, 392 112 C 357 120, 312 118, 260 128 Z M280 108 C 317 98, 347 90, 369 78 C 392 65, 404 50, 399 38 C 394 27, 374 27, 354 40 C 322 62, 297 88, 280 108 Z"
      fill="#c0392b"
      fillRule="evenodd"
    />

    <path
      d="M20 230 L20 430 C20 460, 44 484, 74 484 L438 484 C468 484, 492 460, 492 430 L492 230 Z"
      fill="#f0c419"
    />

    <path
      d="M45 133 L467 133 C481 133, 492 144, 492 158 L492 210 C492 224, 481 235, 467 235 L45 235 C31 235, 20 224, 20 210 L20 158 C20 144, 31 133, 45 133 Z"
      fill="#f0c419"
    />
    ...
    <path
      d="M20 430 C20 460, 44 484, 74 484 L438 484 C468 484, 492 460, 492 430 L492 462 C492 474, 482 484, 470 484 L42 484 C30 484, 20 474, 20 462 Z"
      fill="#e8890c"
      opacity="0.85"
    />
    ...
    <path
      d="M234 100 C 234 78, 244 62, 256 62 C 268 62, 278 78, 278 100 C 278 118, 268 133, 256 133 C 244 133, 234 118, 234 100 Z"
      fill="#e74c3c"
    />
  </svg>
);
