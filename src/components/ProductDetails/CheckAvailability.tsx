    ...
    <div className="lg:flex gap-3 my-6">
      ...
      <button
        onClick={() => setIsEmiOpen(true)}
          className="flex-1 w-full mb-4 lg:mb-0 flex items-center justify-between gap-2 bg-[linear-gradient(90.1deg,#6533F4_0.14%,#A789FF_99.97%)] text-white font-semibold text-sm px-4 py-3 rounded-xl shadow-sm hover:opacity-90 transition-opacity cursor-pointer"
      >
        <div className="flex items-center gap-2">
          <span className="bg-white rounded-lg p-1.5">
            <svg
