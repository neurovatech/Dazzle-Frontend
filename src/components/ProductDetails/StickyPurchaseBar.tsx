...
export default function StickyPurchaseBar({
 ...
 const handleBuyNow = async () => {
  ...
  return (
    <div>
      <div className="fixed md:bottom-0 bottom-0 left-0 right-0 z-9999999 bg-[#f5f5f7] dark:bg-[#3e3329] border-t border-gray-200 dark:border-gray-700/60 shadow-[0_-2px_12px_rgba(0,0,0,0.08)]">
